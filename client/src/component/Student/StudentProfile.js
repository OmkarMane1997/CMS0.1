                ...
                <div className="col-md-4">
                    <div className="card border-0">
                        <div className="position-relative">
                          ...
                          {
                             img ? <img src={img ? img.url : ""} alt="No_Image Found" className="card-img" /> :
                             <img src={currentUser.image ? currentUser.image.url : ""} alt="No_Image Found" className="card-img" />
                          }
                        {
                ...
                <div className="col-md-8">
                   {
                    isEdit ?(
                      ...
                      {currentUser.name} </h4>
                      <button className='btn btn-danger' onClick={toggleEdit}><i className="bi bi-x-circle"></i></button>
                        </div>
                        <hr />
                      ...
                      <div className="card-body">
                        ...
                        <h4 className="card-title text-center text-uppercase text-success"> 
                      {currentUser.name} </h4>
                      <button className='btn btn-info' onClick={toggleEdit}><i className="bi bi-pen"></i></button>
